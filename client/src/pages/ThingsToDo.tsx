...
const activities: Activity[] = [
  ...
  },
  {
    ...
    description: "Popular seaside attraction known for its black sand, breezy coastal views, and vibrant street food stalls.",
    address: "Dumas Beach, Gujarat",
  },
  // {
  //   id: "attraction-2",
  ...
  // },
  {
    ...
    name: "VR Surat",
    category: "shopping",
    description: "Contemporary retail and leisure hub featuring leading brands, diverse eateries, cinemas, and cultural experiences.",
